...
type IMenu interface {
	...
	// 创建菜单
	Create(ctx context.Context, req *dto_menu.Create) (err error)
	// 获取修改信息
	GetEdit(ctx context.Context, id int64) (res *dao_menu.Edit, err error)
	// 修改菜单
	Edit(ctx context.Context, req *dto_menu.Edit) (err error)
	// 删除菜单
	Delete(ctx context.Context, ids []int64) (err error)

	// 检查地址唯一
	CheckCreate(ctx context.Context, req *dto_menu.Create) (err error)
	// 检查特定菜单的地址唯一
	CheckEdit(ctx context.Context, req *dto_menu.Edit) (err error)
}
